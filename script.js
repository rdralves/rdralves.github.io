...
document.addEventListener('DOMContentLoaded', () => {
    ...
    skillItems.forEach(item => {
        item.addEventListener('mouseenter', () => {
            ...
            item.style.boxShadow = '0 5px 15px rgba(37, 99, 235, 0.3)';
        });
...
console.log(`
🚀 Site desenvolvido por Rodrigo Alves dos Reis
💻 GitHub: https://github.com/rdralves
🐍 Especialista em Python, Django e Flask
